...
export type AllSanitySchemaTypes = Settings | Header | Footer | Seo | RichText | MediaGallery | Writers | Projects | MovieClub | Languages | Distributions | TrailerType | ButtonType | TicketType | Directors | Actors | ProjectsGrid | PageTitle | VisibilityType | MoviesHeroCarousel | MovieClubList | MediaCarousel | LogoCarousel | ImageWithText | HeroCarousel | DistributionList | Page | LinkType | MediaType | MediaTag | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
export type FetchHomeResult = {
  ...
  blockList: Array<{
    ...
    showSubstackPostsCard: boolean | null;
  } | {
    _type: "moviesHeroCarousel";
    mediaItems: null;
  }> | null;
