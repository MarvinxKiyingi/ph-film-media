...
export type AllSanitySchemaTypes = Settings | Header | Footer | Seo | RichText | MediaGallery | Writers | MovieClub | Languages | Distributions | TrailerType | ButtonType | TicketType | Directors | Actors | ProjectsGrid | Projects | PageTitle | VisibilityType | MoviesHeroCarousel | MovieClubList | MediaCarousel | LogoCarousel | ImageWithText | HeroCarousel | DistributionList | Page | LinkType | MediaType | MediaTag | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
